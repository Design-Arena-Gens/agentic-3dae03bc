  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 animate-fade-in">
      {panels.map((panel, index) => (
        ...
        >
          <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${panel.color} opacity-10 rounded-full -mr-8 -mt-8`}></div>
          
          <div className="relative">
            <div className="flex items-center justify-between mb-3">
              <div className={`p-3 bg-gradient-to-br ${panel.color} rounded-lg`}>
